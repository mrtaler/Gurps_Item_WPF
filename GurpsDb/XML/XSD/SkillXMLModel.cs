...
namespace GurpsDb.XML.XSD
{
    public class SkillXmlModel
    {
        ...
        {
            int hash = 0;
            if (this.Type != null) hash ^= this.Type.GetHashCode();
            if (this.NameSkill != null) hash ^= this.NameSkill.Value.GetHashCode();
            if (this.Specialization != null) hash ^= this.Specialization.Value.GetHashCode();
            if (this.Version != null) hash ^= this.Version.Value.GetHashCode();
