namespace GurpsDb.Migrations
{
    ...
    public partial class InitialMigration : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    UbWeight = c.Decimal(nullable: false, precision: 7, scale: 3),
                    ...
                    RemoteTrigger = c.Boolean(nullable: false),
                    GasMask = c.Boolean(nullable: false),
                    Alcohol = c.Boolean(nullable: false),
                    Hardware = c.Boolean(nullable: false),
                    Medical = c.Boolean(nullable: false),
                    CamouflageKit = c.Boolean(nullable: false),
                    LocksmithKit = c.Boolean(nullable: false),
                    Toolkit = c.Boolean(nullable: false),
                    FirstAidKit = c.Boolean(nullable: false),
                    MedicalKit = c.Boolean(nullable: false),
                    WireCutters = c.Boolean(nullable: false),
                    Canteen = c.Boolean(nullable: false),
                    GasCan = c.Boolean(nullable: false),
                    Batteries = c.Boolean(nullable: false),
                    NeedsBatteries = c.Boolean(nullable: false),
                    ContainsLiquid = c.Boolean(nullable: false),
                    MetalDetector = c.Boolean(nullable: false),
                    FingerPrintId = c.Boolean(nullable: false),
                    TripWireActivation = c.Boolean(nullable: false),
                    TripWire = c.Boolean(nullable: false),
                    Mount = c.Boolean(nullable: false),
                    Tl = c.Int(nullable: false),
                    Lc = c.Int(nullable: false),
                    SizeBatteries = c.String(maxLength: 4),
                    FoodType = c.Int(nullable: false),
                    LockPickModifier = c.Int(nullable: false),
                    CrowbarModifier = c.Int(nullable: false),
                    DisarmModifier = c.Int(nullable: false),
                    RepairModifier = c.Int(nullable: false),
                    DamageChance = c.Int(nullable: false),
                    Clothestype = c.Int(nullable: false),
                ...
                .ForeignKey("dbo.Caliber", t => t.UbCalibre)
                .ForeignKey("dbo.Clothes", t => t.Clothestype)
                .ForeignKey("dbo.Food", t => t.FoodType)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.UiIndex)
                .ForeignKey("dbo.Item", t => t.UiIndex, cascadeDelete: true)
                .Index(t => t.UiIndex);
            ...
            CreateTable(
                ...
                {
                    UiIndex = c.Int(nullable: false),
                    SzAttName = c.String(nullable: false, maxLength: 80),
            ...
            CreateTable(
                ...
                c => new
                {
                    UiSlotIndex = c.Int(nullable: false, identity: true),
                    SzSlotName = c.String(nullable: false, maxLength: 50),
                })
                .PrimaryKey(t => t.UiSlotIndex);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Attachment", t => t.IdAttach, cascadeDelete: true)
                .Index(t => t.IdAttach)
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    DimOfBulletSi = c.Decimal(precision: 8, scale: 4),
                    DimOfBulletUs = c.Decimal(precision: 8, scale: 4),
                })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.LbeIndex)
                .ForeignKey("dbo.Item", t => t.LbeIndex, cascadeDelete: true)
                .Index(t => t.LbeIndex);
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    StartMoney = c.Decimal(precision: 19, scale: 4),
                })
                .PrimaryKey(t => t.IdTl);
            ...
            CreateTable(
                ...
                {
                    UiIndex = c.Int(nullable: false),
                    SzWeaponName = c.String(nullable: false, maxLength: 80),
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Weapon", t => t.IdWeapon, cascadeDelete: true)
                .Index(t => t.IdWeapon)
            ...
            CreateTable(
                ...
                {
                    Id = c.Int(nullable: false, identity: true),
                    NamelCategory = c.String(maxLength: 50),
                })
                .PrimaryKey(t => t.Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Item", "FoodType", "dbo.Food");
            DropForeignKey("dbo.Explosive", "UiIndex", "dbo.Item");
            DropForeignKey("dbo.Drug", "Id", "dbo.Item");
            DropForeignKey("dbo.Item", "Clothestype", "dbo.Clothes");
