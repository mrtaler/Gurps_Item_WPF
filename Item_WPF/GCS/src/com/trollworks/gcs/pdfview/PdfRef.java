...
public class PdfRef implements Comparable<PdfRef> {
	 ...
	 */
	public static synchronized List<PdfRef> getKnown(bool requireExistence) {
	 ...
	 */
	public static synchronized PdfRef lookup(String id, bool requireExistence) {
		Preferences prefs = Preferences.getInstance();
		prefs.resetIfVersionMisMatch(MODULE, VERSION);
