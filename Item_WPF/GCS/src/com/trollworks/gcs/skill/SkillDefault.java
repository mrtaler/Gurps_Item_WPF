...
public class SkillDefault {
	...
	/** The XML tag. */
	public static const String	TAG_ROOT			= "default";		//$NON-NLS-1$
	/** The tag used for the type. */
	public static const String	TAG_TYPE			= "type";			//$NON-NLS-1$
	...
	public static const String	TAG_SPECIALIZATION	= "specialization";	//$NON-NLS-1$
