...
//using com.trollworks.gcs.modifier.ModifierListEditor;
//using com.trollworks.gcs.prereq.PrereqsPanel;
//using com.trollworks.gcs.skill.Defaults;
...
//		bool notContainer = !advantage.canHaveChildren();
//		if (notContainer) {
...
//	private LinkedLabel createTypeLabel(RetinaIcon icon, const JCheckBox linkTo) {
...
//		bool modified = mRow.setName((String) mNameField.getValue());
...
//	private bool shouldRoundCostDown() {
