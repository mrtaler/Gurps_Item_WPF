...
public abstract class EditorPanel extends ActionPanel implements ActionListener, PropertyChangeListener {
	...
	private static const String	COMPARISON	= "Comparison";	//$NON-NLS-1$
	 ...
	 */
	protected EditorField addNumericCompareField(IntegerCriteria compare, int min, int max, bool forceSign) {
	 ...
	 */
	protected EditorField addNumericCompareField(DoubleCriteria compare, double min, double max, bool forceSign) {
