...
using java.awt.event.ItemEvent;
using java.awt.event.ItemListener;
using java.io.File;
using java.net.URI;
...
using javax.swing.text.Document;
...
public class SheetPreferences extends PreferencePanel implements ActionListener, DocumentListener, ItemListener {
	...
	private static const String			MODULE								= "Sheet";														//$NON-NLS-1$
	private static const String			OPTIONAL_DICE_RULES_KEY				= "UseOptionDiceRules";											//$NON-NLS-1$
	/** The optional dice rules preference key. */
	public static const String			OPTIONAL_DICE_RULES_PREF_KEY		= Preferences.getModuleKey(MODULE, OPTIONAL_DICE_RULES_KEY);
	private static const bool		DEFAULT_OPTIONAL_DICE_RULES			= false;
	private static const String			OPTIONAL_IQ_RULES_KEY				= "UseOptionIQRules";											//$NON-NLS-1$
	/** The optional IQ rules preference key. */
	public static const String			OPTIONAL_IQ_RULES_PREF_KEY			= Preferences.getModuleKey(MODULE, OPTIONAL_IQ_RULES_KEY);
	private static const bool		DEFAULT_OPTIONAL_IQ_RULES			= false;
	private static const String			OPTIONAL_MODIFIER_RULES_KEY			= "UseOptionModifierRules";										//$NON-NLS-1$
	/** The optional modifier rules preference key. */
	public static const String			OPTIONAL_MODIFIER_RULES_PREF_KEY	= Preferences.getModuleKey(MODULE, OPTIONAL_MODIFIER_RULES_KEY);
	private static const bool		DEFAULT_OPTIONAL_MODIFIER_RULES		= false;
	private static const String			AUTO_NAME_KEY						= "AutoNameNewCharacters";										//$NON-NLS-1$
	/** The auto-naming preference key. */
	public static const String			AUTO_NAME_PREF_KEY					= Preferences.getModuleKey(MODULE, AUTO_NAME_KEY);
	private static const bool		DEFAULT_AUTO_NAME					= true;
	private static const String			LENGTH_UNITS_KEY					= "LengthUnits";												//$NON-NLS-1$
	/** The default length units preference key. */
	public static const String			LENGTH_UNITS_PREF_KEY				= Preferences.getModuleKey(MODULE, LENGTH_UNITS_KEY);
	private static const LengthUnits	DEFAULT_LENGTH_UNITS				= LengthUnits.FT_IN;
	private static const String			WEIGHT_UNITS_KEY					= "WeightUnits";												//$NON-NLS-1$
	/** The default weight units preference key. */
	public static const String			WEIGHT_UNITS_PREF_KEY				= Preferences.getModuleKey(MODULE, WEIGHT_UNITS_KEY);
	private static const WeightUnits	DEFAULT_WEIGHT_UNITS				= WeightUnits.LB;
	private static const String			TOTAL_POINTS_DISPLAY_KEY			= "TotalPointsIncludesUnspentPoints";							//$NON-NLS-1$
	/** The total points includes unspent points preference key. */
	public static const String			TOTAL_POINTS_DISPLAY_PREF_KEY		= Preferences.getModuleKey(MODULE, TOTAL_POINTS_DISPLAY_KEY);
	private static const bool		DEFAULT_TOTAL_POINTS_DISPLAY		= true;
	private static const String			GURPS_METRIC_RULES_KEY				= "UseGurpsMetricRules";										//$NON-NLS-1$
	/** The GURPS Metric preference key. */
	public static const String			GURPS_METRIC_RULES_PREF_KEY			= Preferences.getModuleKey(MODULE, GURPS_METRIC_RULES_KEY);
	private static const bool		DEFAULT_GURPS_METRIC_RULES			= true;
	private static const int			DEFAULT_PNG_RESOLUTION				= 200;
	private static const String			PNG_RESOLUTION_KEY					= "PNGResolution";												//$NON-NLS-1$
	private static const int[]			DPI									= { 72, 96, 144, 150, 200, 300 };
	private static const String			USE_HTML_TEMPLATE_OVERRIDE_KEY		= "UseHTMLTemplateOverride";									//$NON-NLS-1$
	private static const String			HTML_TEMPLATE_OVERRIDE_KEY			= "HTMLTemplateOverride";										//$NON-NLS-1$
	private static const String			GURPS_CALCULATOR_KEY_KEY			= "GurpsCalculatorKey";											//$NON-NLS-1$
	public static const String			BASE_GURPS_CALCULATOR_URL			= "http://www.gurpscalculator.com";								//$NON-NLS-1$
	public static const String			GURPS_CALCULATOR_URL				= BASE_GURPS_CALCULATOR_URL + "/Character/usingGCS";			//$NON-NLS-1$
	private static const String			INITIAL_POINTS_KEY					= "InitialPoints";												//$NON-NLS-1$
	private static const int			DEFAULT_INITIAL_POINTS				= 100;
	...
	private static void adjustOptionalDiceRulesProperty(bool use) {
		Dice.setConvertModifiersToExtraDice(use);
	}

	/** @return Whether the optional dice rules from B269 are in use. */
	public static bool areOptionalDiceRulesUsed() {
		return Preferences.getInstance().getboolValue(MODULE, OPTIONAL_DICE_RULES_KEY, DEFAULT_OPTIONAL_DICE_RULES);
	}

	/**
	 * @return Whether the optional IQ rules (Will &amp; Perception are not based on IQ) are in use.
	 */
	public static bool areOptionalIQRulesUsed() {
		return Preferences.getInstance().getboolValue(MODULE, OPTIONAL_IQ_RULES_KEY, DEFAULT_OPTIONAL_IQ_RULES);
	}

	/** @return Whether the optional modifier rules from PW102 are in use. */
	public static bool areOptionalModifierRulesUsed() {
		return Preferences.getInstance().getboolValue(MODULE, OPTIONAL_MODIFIER_RULES_KEY, DEFAULT_OPTIONAL_MODIFIER_RULES);
	}
	 ...
	 *         (but unspent) points.
	 */
	public static bool shouldIncludeUnspentPointsInTotalPointDisplay() {
		return Preferences.getInstance().getboolValue(MODULE, TOTAL_POINTS_DISPLAY_KEY, DEFAULT_TOTAL_POINTS_DISPLAY);
	}

	/** @return Whether the GURPS Metrics rules are used for weight and height conversion. */
	public static bool areGurpsMetricRulesUsed() {
		return Preferences.getInstance().getboolValue(MODULE, GURPS_METRIC_RULES_KEY, DEFAULT_GURPS_METRIC_RULES);
	}

	/** @return Whether a new character should be automatically named. */
	public static bool isNewCharacterAutoNamed() {
		return Preferences.getInstance().getboolValue(MODULE, AUTO_NAME_KEY, DEFAULT_AUTO_NAME);
	}
	...
	public static bool isHTMLTemplateOverridden() {
		return Preferences.getInstance().getboolValue(MODULE, USE_HTML_TEMPLATE_OVERRIDE_KEY);
	}
	...
	public void itemStateChanged(ItemEvent event) {
		...
		if (source == mUseHTMLTemplateOverride) {
			bool checked = mUseHTMLTemplateOverride.isSelected();
			...
			bool checked = mUseOptionalDiceRules.isSelected();
