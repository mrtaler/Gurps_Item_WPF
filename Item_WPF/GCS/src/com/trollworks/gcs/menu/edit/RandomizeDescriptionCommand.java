...
using com.trollworks.gcs.character.DescriptionRandomizer;
...
public class RandomizeDescriptionCommand extends Command {
	...
	public static const String						CMD_RANDOMIZE_DESCRIPTION	= "RandomizeDescription";			//$NON-NLS-1$

	/** The singleton {@link RandomizeDescriptionCommand}. */
	public static const RandomizeDescriptionCommand	INSTANCE					= new RandomizeDescriptionCommand();
