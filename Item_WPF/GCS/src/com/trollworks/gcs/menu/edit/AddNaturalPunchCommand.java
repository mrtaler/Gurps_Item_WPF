...
public class AddNaturalPunchCommand extends Command {
	...
	public static const String					CMD_ADD_NATURAL_PUNCH	= "AddNaturalPunch";			//$NON-NLS-1$

	/** The singleton {@link AddNaturalPunchCommand}. */
	public static const AddNaturalPunchCommand	INSTANCE				= new AddNaturalPunchCommand();
