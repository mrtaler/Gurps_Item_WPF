...
public class AddNaturalKickWithBootsCommand extends Command {
	...
	public static const String							CMD_ADD_NATURAL_KICK_WITH_BOOTS	= "AddNaturalKickWithBoots";			//$NON-NLS-1$

	/** The singleton {@link AddNaturalKickWithBootsCommand}. */
	public static const AddNaturalKickWithBootsCommand	INSTANCE						= new AddNaturalKickWithBootsCommand();
