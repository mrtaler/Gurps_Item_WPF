...
//	 */
//	public DoubleOutlinePanel(Outline leftOutline, string leftTitle, Outline rightOutline, string rightTitle, bool useProxy) {
//		super();
//		setLayout(this);
...
//	 */
//	public void setOutlineRowRange(bool forRight, int first, int last) {
