...
using com.trollworks.gcs.advantage.AdvantageContainerType;
...
using com.trollworks.gcs.feature.AttributeBonusLimitation;
...
using com.trollworks.toolkit.ui.print.PageOrientation;
...
using com.trollworks.toolkit.utility.Dice;
...
public class GURPSCharacter extends DataFile {
	...
	public static const String					EXTENSION								= "gcs";														//$NON-NLS-1$
	private static const int					CURRENT_VERSION							= 2;
	private static const String					EMPTY									= "";															//$NON-NLS-1$
	private static const String					TAG_ROOT								= "character";													//$NON-NLS-1$
	private static const String					TAG_CREATED_DATE						= "created_date";												//$NON-NLS-1$
	private static const String					TAG_MODIFIED_DATE						= "modified_date";												//$NON-NLS-1$
	private static const String					TAG_CURRENT_HP							= "current_hp";													//$NON-NLS-1$
	private static const String					TAG_CURRENT_FP							= "current_fp";													//$NON-NLS-1$
	private static const String					TAG_UNSPENT_POINTS						= "unspent_points";												//$NON-NLS-1$
	private static const String					TAG_TOTAL_POINTS						= "total_points";												//$NON-NLS-1$
	private static const String					TAG_INCLUDE_PUNCH						= "include_punch";												//$NON-NLS-1$
	private static const String					TAG_INCLUDE_KICK						= "include_kick";												//$NON-NLS-1$
	private static const String					TAG_INCLUDE_BOOTS						= "include_kick_with_boots";									//$NON-NLS-1$
	private static const String					ATTRIBUTE_CARRIED						= "carried";													//$NON-NLS-1$
	/** The prefix for all character IDs. */
	public static const String					CHARACTER_PREFIX						= "gcs.";														//$NON-NLS-1$
	/** The field ID for last modified date changes. */
	public static const String					ID_LAST_MODIFIED						= CHARACTER_PREFIX + "LastModifiedDate";						//$NON-NLS-1$
	/** The field ID for created on date changes. */
	public static const String					ID_CREATED_ON							= CHARACTER_PREFIX + "CreatedOn";								//$NON-NLS-1$
	/** The field ID for include punch changes. */
	public static const String					ID_INCLUDE_PUNCH						= CHARACTER_PREFIX + "IncludePunch";							//$NON-NLS-1$
	/** The field ID for include kick changes. */
	public static const String					ID_INCLUDE_KICK							= CHARACTER_PREFIX + "IncludeKickFeet";							//$NON-NLS-1$
	/** The field ID for include kick with boots changes. */
	public static const String					ID_INCLUDE_BOOTS						= CHARACTER_PREFIX + "IncludeKickBoots";						//$NON-NLS-1$
	/**
	 * The prefix used to indicate a point value is requested from {@link #getValueForID(String)}.
	 */
	public static const String					POINTS_PREFIX							= CHARACTER_PREFIX + "points.";									//$NON-NLS-1$
	...
	public static const String					ID_CARRIED_WEALTH						= CHARACTER_PREFIX + "CarriedWealth";							//$NON-NLS-1$
	/** The prefix used in front of all IDs for encumbrance changes. */
	public static const String					MAXIMUM_CARRY_PREFIX					= ATTRIBUTES_PREFIX + "MaximumCarry";							//$NON-NLS-1$
	private static const String					LIFT_PREFIX								= ATTRIBUTES_PREFIX + "lift.";									//$NON-NLS-1$
	/** The field ID for basic lift changes. */
	public static const String					ID_BASIC_LIFT							= LIFT_PREFIX + "BasicLift";									//$NON-NLS-1$
	/** The field ID for one-handed lift changes. */
	public static const String					ID_ONE_HANDED_LIFT						= LIFT_PREFIX + "OneHandedLift";								//$NON-NLS-1$
	/** The field ID for two-handed lift changes. */
	public static const String					ID_TWO_HANDED_LIFT						= LIFT_PREFIX + "TwoHandedLift";								//$NON-NLS-1$
	/** The field ID for shove and knock over changes. */
	public static const String					ID_SHOVE_AND_KNOCK_OVER					= LIFT_PREFIX + "ShoveAndKnockOver";							//$NON-NLS-1$
	/** The field ID for running shove and knock over changes. */
	public static const String					ID_RUNNING_SHOVE_AND_KNOCK_OVER			= LIFT_PREFIX + "RunningShoveAndKnockOver";						//$NON-NLS-1$
	/** The field ID for carry on back changes. */
	public static const String					ID_CARRY_ON_BACK						= LIFT_PREFIX + "CarryOnBack";									//$NON-NLS-1$
	/** The field ID for carry on back changes. */
	public static const String					ID_SHIFT_SLIGHTLY						= LIFT_PREFIX + "ShiftSlightly";								//$NON-NLS-1$
	...
	public static const String					ID_DISADVANTAGE_POINTS					= POINT_SUMMARY_PREFIX + "DisadvantagePoints";					//$NON-NLS-1$
	/** The field ID for quirk point summary changes. */
	public static const String					ID_QUIRK_POINTS							= POINT_SUMMARY_PREFIX + "QuirkPoints";							//$NON-NLS-1$
	/** The field ID for skill point summary changes. */
	public static const String					ID_SKILL_POINTS							= POINT_SUMMARY_PREFIX + "SkillPoints";							//$NON-NLS-1$
	/** The field ID for spell point summary changes. */
	public static const String					ID_SPELL_POINTS							= POINT_SUMMARY_PREFIX + "SpellPoints";							//$NON-NLS-1$
	/** The field ID for racial point summary changes. */
	public static const String					ID_RACE_POINTS							= POINT_SUMMARY_PREFIX + "RacePoints";							//$NON-NLS-1$
	/** The field ID for earned point changes. */
	public static const String					ID_EARNED_POINTS						= POINT_SUMMARY_PREFIX + "EarnedPoints";						//$NON-NLS-1$
	/** The prefix used in front of all IDs for basic damage. */
	public static const String					BASIC_DAMAGE_PREFIX						= CHARACTER_PREFIX + "bd.";										//$NON-NLS-1$
	/** The field ID for basic thrust damage changes. */
	public static const String					ID_BASIC_THRUST							= BASIC_DAMAGE_PREFIX + "Thrust";								//$NON-NLS-1$
	...
	public static const String					ID_REELING_HIT_POINTS					= HIT_POINTS_PREFIX + "Reeling";								//$NON-NLS-1$
	/** The field ID for unconscious check hit point changes. */
	public static const String					ID_UNCONSCIOUS_CHECKS_HIT_POINTS		= HIT_POINTS_PREFIX + "UnconsciousChecks";						//$NON-NLS-1$
	/** The field ID for death check #1 hit point changes. */
	public static const String					ID_DEATH_CHECK_1_HIT_POINTS				= HIT_POINTS_PREFIX + "DeathCheck1";							//$NON-NLS-1$
	/** The field ID for death check #2 hit point changes. */
	public static const String					ID_DEATH_CHECK_2_HIT_POINTS				= HIT_POINTS_PREFIX + "DeathCheck2";							//$NON-NLS-1$
	/** The field ID for death check #3 hit point changes. */
	public static const String					ID_DEATH_CHECK_3_HIT_POINTS				= HIT_POINTS_PREFIX + "DeathCheck3";							//$NON-NLS-1$
	/** The field ID for death check #4 hit point changes. */
	public static const String					ID_DEATH_CHECK_4_HIT_POINTS				= HIT_POINTS_PREFIX + "DeathCheck4";							//$NON-NLS-1$
	...
	public static const String					ID_TIRED_FATIGUE_POINTS					= FATIGUE_POINTS_PREFIX + "Tired";								//$NON-NLS-1$
	/** The field ID for unconscious check fatigue point changes. */
	public static const String					ID_UNCONSCIOUS_CHECKS_FATIGUE_POINTS	= FATIGUE_POINTS_PREFIX + "UnconsciousChecks";					//$NON-NLS-1$
	/** The field ID for unconscious fatigue point changes. */
	public static const String					ID_UNCONSCIOUS_FATIGUE_POINTS			= FATIGUE_POINTS_PREFIX + "Unconscious";						//$NON-NLS-1$
	...
	private bool								mDidModify;
	private bool								mNeedAttributePointCalculation;
	private bool								mNeedAdvantagesPointCalculation;
	private bool								mNeedSkillPointCalculation;
	private bool								mNeedSpellPointCalculation;
	private bool								mNeedEquipmentCalculation;
	...
	private bool								mSkillsUpdated;
	private bool								mSpellsUpdated;
	private PrintManager						mPageSettings;
	private bool								mIncludePunch;
	private bool								mIncludeKick;
	private bool								mIncludeKickBoots;
	...
	private void characterInitialize(bool full) {
	...
	@Override
	protected const void loadSelf(XMLReader reader, LoadState state) throws IOException {
	...
	public void setValueForID(String id, Object value) {
		if (id != null) {
			if (ID_CREATED_ON.equals(id)) {
				...
				setIncludePunch(((bool) value).boolValue());
			} else if (ID_INCLUDE_KICK.equals(id)) {
				setIncludeKick(((bool) value).boolValue());
			} else if (ID_INCLUDE_BOOTS.equals(id)) {
				setIncludeKickBoots(((bool) value).boolValue());
			} else if (ID_STRENGTH.equals(id)) {
	...
	private void updateStrengthInfo(int strength, int bonus, int liftingBonus, int strikingBonus) {
		...
		bool notifyST = mStrength != strength || mStrengthBonus != bonus;
		Dice dice;
	 ...
	 *            the previous values.
	 */
	public void calculateWeightAndWealthCarried(bool notify) {
	...
	public bool includePunch() {
		return mIncludePunch;
	}

	/** @param include Whether to include the punch natural weapon or not. */
	public void setIncludePunch(bool include) {
		if (mIncludePunch != include) {
			postUndoEdit(INCLUDE_PUNCH_UNDO, ID_INCLUDE_PUNCH, new bool(mIncludePunch), new bool(include));
			mIncludePunch = include;
			notifySingle(ID_INCLUDE_PUNCH, new bool(mIncludePunch));
		}
	}

	/** @return Whether to include the kick natural weapon or not. */
	public bool includeKick() {
		return mIncludeKick;
	}

	/** @param include Whether to include the kick natural weapon or not. */
	public void setIncludeKick(bool include) {
		if (mIncludeKick != include) {
			postUndoEdit(INCLUDE_KICK_UNDO, ID_INCLUDE_KICK, new bool(mIncludeKick), new bool(include));
			mIncludeKick = include;
			notifySingle(ID_INCLUDE_KICK, new bool(mIncludeKick));
		}
	}

	/** @return Whether to include the kick w/boots natural weapon or not. */
	public bool includeKickBoots() {
		return mIncludeKickBoots;
	}

	/** @param include Whether to include the kick w/boots natural weapon or not. */
	public void setIncludeKickBoots(bool include) {
		if (mIncludeKickBoots != include) {
			postUndoEdit(INCLUDE_BOOTS_UNDO, ID_INCLUDE_BOOTS, new bool(mIncludeKickBoots), new bool(include));
			mIncludeKickBoots = include;
			notifySingle(ID_INCLUDE_BOOTS, new bool(mIncludeKickBoots));
		}
	}
