...
public class PageAssembler {
	private static const int	VERTICAL_SLOP	= 4;	// Shouldn't be necessary, but prevents
														// cut-offs
	 ...
	 */
	public bool addToContent(Container panel, OutlineInfo leftInfo, OutlineInfo rightInfo) {
		bool isOutline = panel instanceof SingleOutlinePanel || panel instanceof DoubleOutlinePanel;
		int height = 0;
		int minLeft = 0;
		int minRight = 0;
