...
//using com.lowagie.text.pdf.DefaultFontMapper;
//using com.lowagie.text.pdf.PdfContentByte;
//using com.lowagie.text.pdf.PdfTemplate;
//using com.lowagie.text.pdf.PdfWriter;
//using com.trollworks.gcs.advantage.Advantage;
//using com.trollworks.gcs.advantage.AdvantageColumn;
...
//using com.trollworks.gcs.spell.SpellColumn;
...
//using com.trollworks.gcs.weapon.WeaponDisplayRow;
...
//using com.trollworks.toolkit.ui.Fonts;
...
//using com.trollworks.toolkit.ui.layout.RowDistribution;
...
//using java.awt.print.PageFormat;
//using java.awt.print.Paper;
...
//using javax.swing.RepaintManager;
//using javax.swing.Scrollable;
//using javax.swing.SwingConstants;
//using javax.swing.SwingUtilities;
//using javax.swing.UIManager;
//using javax.swing.event.ChangeEvent;
//using javax.swing.event.ChangeListener;
...
//	private static const String	BOXING_SKILL_NAME	= "Boxing";		//$NON-NLS-1$
//	private static const String	KARATE_SKILL_NAME	= "Karate";		//$NON-NLS-1$
//	private static const String	BRAWLING_SKILL_NAME	= "Brawling";	//$NON-NLS-1$
...
//	private bool				mRebuildPending;
//	private HashSet<Outline>	mRootsToSync;
//	private PrintManager		mPrintManager;
//	private bool				mIsPrinting;
//	private bool				mSyncWeapons;
...
//		}
//		Preferences.getInstance().getNotifier().add(this, SheetPreferences.OPTIONAL_DICE_RULES_PREF_KEY, Fonts.FONT_NOTIFICATION_KEY, SheetPreferences.WEIGHT_UNITS_PREF_KEY, SheetPreferences.GURPS_METRIC_RULES_PREF_KEY);
//	}
...
//	private bool restoreFocusToKey(String key, Component panel) {
//		if (key != null) {
...
//			bool savedModified = mCharacter.isModified();
...
//			bool saved = mgr.isDoubleBufferingEnabled();
...
//	 */
//	public bool saveAsPDF(File file) {
...
//	@Override
//	public bool exportToGurpsCalculator() throws IOException, NotImplementedException {
...
//	private bool showExistsDialogIfNecessary(WebServiceClient client) throws MalformedURLException, IOException, NotImplementedException {
//		String key = SheetPreferences.getGurpsCalculatorKey();
...
//	 * @return <code>true</code> on success.
//	 */
//	public bool saveAsHTML(File file, File template, StringBuilder templateUsed) {
//		try {
...
//		ALL {
//			@Override
//			public bool shouldInclude(Advantage advantage) {
//				return true;
//			}
//		},
//		ADS {
...
//		public abstract bool shouldInclude(Advantage advantage);
//	}
...
//	private static bool processDescription(String key, BufferedWriter out, ListRow row) throws IOException {
...
//		if (text.length() > 0) {
//			bool parenVersion = key.endsWith("_PAREN"); //$NON-NLS-1$
//			if (parenVersion) {
//				out.write(" ("); //$NON-NLS-1$
//			}
...
//	private static bool processStyleIndentWarning(String key, BufferedWriter out, ListRow row, bool odd) throws IOException {
...
//	private static bool processDescription(String key, BufferedWriter out, WeaponStats stats) throws IOException {
//		if (key.equals("DESCRIPTION")) { //$NON-NLS-1$
...
//	 * @return <code>true</code> on success.
//	 */
//	public bool saveAsPNG(File file, ArrayList<File> createdFiles) {
//		HashSet<Row> changed = expandAllContainers();
//		try {
