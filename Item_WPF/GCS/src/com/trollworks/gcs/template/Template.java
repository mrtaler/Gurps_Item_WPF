...
using javax.swing.undo.StateEditable;
...
public class Template extends DataFile implements StateEditable {
	...
	public static const String	EXTENSION				= "gct";							//$NON-NLS-1$
	private static const int	CURRENT_VERSION			= 1;
	private static const String	TAG_ROOT				= "template";						//$NON-NLS-1$
	private static const String	TAG_NOTES				= "notes";							//$NON-NLS-1$
	/** The prefix for all template IDs. */
	public static const String	TEMPLATE_PREFIX			= "gct.";							//$NON-NLS-1$
	/**
	 * The prefix used to indicate a point value is requested from {@link #getValueForID(String)}.
	 */
	public static const String	POINTS_PREFIX			= TEMPLATE_PREFIX + "points.";		//$NON-NLS-1$
	/** The field ID for point total changes. */
	public static const String	ID_TOTAL_POINTS			= POINTS_PREFIX + "Total";			//$NON-NLS-1$
	/** The field ID for advantage point summary changes. */
	public static const String	ID_ADVANTAGE_POINTS		= POINTS_PREFIX + "Advantages";		//$NON-NLS-1$
	/** The field ID for disadvantage point summary changes. */
	public static const String	ID_DISADVANTAGE_POINTS	= POINTS_PREFIX + "Disadvantages";	//$NON-NLS-1$
	/** The field ID for quirk point summary changes. */
	public static const String	ID_QUIRK_POINTS			= POINTS_PREFIX + "Quirks";			//$NON-NLS-1$
	/** The field ID for skill point summary changes. */
	public static const String	ID_SKILL_POINTS			= POINTS_PREFIX + "Skills";			//$NON-NLS-1$
	/** The field ID for spell point summary changes. */
	public static const String	ID_SPELL_POINTS			= POINTS_PREFIX + "Spells";			//$NON-NLS-1$
	/** The field ID for notes changes. */
	public static const String	ID_NOTES				= TEMPLATE_PREFIX + "Notes";		//$NON-NLS-1$
