...
public class AttributePrereq extends HasPrereq {
	...
	public static const BonusAttributeType[]	TYPES					= { BonusAttributeType.ST, BonusAttributeType.DX, BonusAttributeType.IQ, BonusAttributeType.HT, BonusAttributeType.WILL, BonusAttributeType.PERCEPTION };
	/** The XML tag for this class. */
	public static const String					TAG_ROOT				= "attribute_prereq";																																		//$NON-NLS-1$
	private static const String					ATTRIBUTE_WHICH			= "which";																																					//$NON-NLS-1$
	private static const String					ATTRIBUTE_COMBINED_WITH	= "combined_with";																																			//$NON-NLS-1$
