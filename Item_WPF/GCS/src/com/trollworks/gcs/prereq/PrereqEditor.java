...
public abstract class PrereqEditor extends EditorPanel {
	...
	private static const String		CHANGE_HAS			= "ChangeHas";																															//$NON-NLS-1$
	private static const Class<?>[]	BASE_TYPES			= new Class<?>[] { AttributePrereq.class, AdvantagePrereq.class, SkillPrereq.class, SpellPrereq.class, ContainedWeightPrereq.class };
	 ...
	 */
	protected JComboBox<Object> addHasCombo(bool has) {
