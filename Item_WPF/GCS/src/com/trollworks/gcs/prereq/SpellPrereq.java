...
public class SpellPrereq extends HasPrereq {
	...
	public static const String	TAG_ROOT			= "spell_prereq";	//$NON-NLS-1$
	/** The tag/type for name comparison. */
	public static const String	TAG_NAME			= "name";			//$NON-NLS-1$
	/** The tag/type for any. */
	public static const String	TAG_ANY				= "any";			//$NON-NLS-1$
	/** The tag/type for college name comparison. */
	public static const String	TAG_COLLEGE			= "college";		//$NON-NLS-1$
	/** The tag/type for college count comparison. */
	public static const String	TAG_COLLEGE_COUNT	= "college_count";	//$NON-NLS-1$
