...
using com.trollworks.gcs.criteria.IntegerCriteria;
...
public class PrereqList extends Prereq {
	...
	public static const String	TAG_ROOT		= "prereq_list";	//$NON-NLS-1$
	private static const String	TAG_WHEN_TL		= "when_tl";		//$NON-NLS-1$
	private static const String	ATTRIBUTE_ALL	= "all";			//$NON-NLS-1$
	private bool				mAll;
	 ...
	 */
	public PrereqList(PrereqList parent, bool all) {
		super(parent);
		mAll = all;
	 ...
	 */
	public static bool isWhenTLEnabled(IntegerCriteria criteria) {
	 ...
	 */
	public static void setWhenTLEnabled(IntegerCriteria criteria, bool enabled) {
	 ...
	 *            be met.
	 */
	public void setRequiresAll(bool requiresAll) {
		mAll = requiresAll;
	}
	...
	public bool satisfied(GURPSCharacter character, ListRow exclude, StringBuilder builder, String prefix) {
		...
		bool satisfied = satisfiedCount == total || !requiresAll && satisfiedCount > 0;
