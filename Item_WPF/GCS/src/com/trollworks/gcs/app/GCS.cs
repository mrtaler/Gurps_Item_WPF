...
//using com.trollworks.gcs.character.PrerequisitesThread;
...
//	private static const CmdLineOption	PDF_OPTION				= new CmdLineOption(PDF_OPTION_DESCRIPTION, null, FileType.PDF_EXTENSION);
//	private static const CmdLineOption	HTML_OPTION				= new CmdLineOption(HTML_OPTION_DESCRIPTION, null, FileType.HTML_EXTENSION);
//	private static const CmdLineOption	HTML_TEMPLATE_OPTION	= new CmdLineOption(HTML_TEMPLATE_OPTION_DESCRIPTION, HTML_TEMPLATE_ARG, "html_template");	//$NON-NLS-1$
//	private static const CmdLineOption	PNG_OPTION				= new CmdLineOption(PNG_OPTION_DESCRIPTION, null, FileType.PNG_EXTENSION);
//	private static const CmdLineOption	SIZE_OPTION				= new CmdLineOption(SIZE_OPTION_DESCRIPTION, "SIZE", "paper");								//$NON-NLS-1$ //$NON-NLS-2$
//	private static const CmdLineOption	MARGIN_OPTION			= new CmdLineOption(MARGIN_OPTION_DESCRIPTION, "MARGINS", "margins");						//$NON-NLS-1$ //$NON-NLS-2$
//	private static const String			REFERENCE_URL			= "http://gcs.trollworks.com";																//$NON-NLS-1$
...
//			System.setProperty("java.awt.headless", bool.TRUE.toString()); //$NON-NLS-1$
//			initialize();
...
//		bool html = cmdLine.isOptionUsed(GCS.HTML_OPTION);
//		bool pdf = cmdLine.isOptionUsed(GCS.PDF_OPTION);
//		bool png = cmdLine.isOptionUsed(GCS.PNG_OPTION);
//		int count = 0;
