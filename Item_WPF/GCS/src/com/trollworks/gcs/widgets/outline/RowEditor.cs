...
//	static public bool edit(Component owner, List<? extends ListRow> list) {
//		ArrayList<RowUndo> undos = new ArrayList<RowUndo>();
//		ListRow[] rows = list.toArray(new ListRow[0]);

//		for (int i = 0; i < rows.length; i++) {
//			bool hasMore = i != rows.length - 1;
//			ListRow row = rows[i];
...
//	 * @return Whether anything was modified.
//	 */
//	public const bool applyChanges() {
//		Commitable.sendCommitToFocusOwner();
//		bool modified = applyChangesSelf();
//		if (modified) {
...
//	 * @return Whether anything was modified.
//	 */
//	protected abstract bool applyChangesSelf();
