...
using com.trollworks.gcs.skill.SkillAttribute;
using com.trollworks.gcs.skill.SkillDifficulty;
...
public class SpellEditor extends RowEditor<Spell> implements ActionListener, DocumentListener {
	...
	public SpellEditor(Spell spell) {
		...
		bool notContainer = !spell.canHaveChildren();
	...
	private Container createPointsFields() {
		bool forCharacter = mRow.getCharacter() != null;
		bool forTemplate = mRow.getTemplate() != null;
	...
	public bool applyChangesSelf() {
		...
		bool notContainer = !mRow.canHaveChildren();
	...
	public void actionPerformed(ActionEvent event) {
		...
		if (src == mHasTechLevel) {
			bool enabled = mHasTechLevel.isSelected();
