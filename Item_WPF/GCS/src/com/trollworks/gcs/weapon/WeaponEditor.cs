...
//using com.trollworks.toolkit.ui.layout.PrecisionLayout;
...
//	@Override
//	public const void actionPerformed(ActionEvent event) {
...
//	private void setWeaponState(bool enabled) {
//		mRespond = false;
//		if (enabled) {
//			updateFields();
