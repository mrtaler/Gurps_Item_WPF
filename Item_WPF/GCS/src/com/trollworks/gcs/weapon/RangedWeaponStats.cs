...
//	/** The root XML tag. */
//	public static const String	TAG_ROOT			= "ranged_weapon";			//$NON-NLS-1$
//	private static const String	TAG_ACCURACY		= "accuracy";				//$NON-NLS-1$
//	private static const String	TAG_RANGE			= "range";					//$NON-NLS-1$
//	private static const String	TAG_RATE_OF_FIRE	= "rate_of_fire";			//$NON-NLS-1$
//	private static const String	TAG_SHOTS			= "shots";					//$NON-NLS-1$
//	private static const String	TAG_BULK			= "bulk";					//$NON-NLS-1$
//	private static const String	TAG_RECOIL			= "recoil";					//$NON-NLS-1$
//	/** The field ID for accuracy changes. */
//	public static const String	ID_ACCURACY			= PREFIX + TAG_ACCURACY;
//	/** The field ID for range changes. */
//	public static const String	ID_RANGE			= PREFIX + TAG_RANGE;
//	/** The field ID for rate of fire changes. */
//	public static const String	ID_RATE_OF_FIRE		= PREFIX + TAG_RATE_OF_FIRE;
//	/** The field ID for shots changes. */
//	public static const String	ID_SHOTS			= PREFIX + TAG_SHOTS;
//	/** The field ID for bulk changes. */
//	public static const String	ID_BULK				= PREFIX + TAG_BULK;
//	/** The field ID for recoil changes. */
//	public static const String	ID_RECOIL			= PREFIX + TAG_RECOIL;
