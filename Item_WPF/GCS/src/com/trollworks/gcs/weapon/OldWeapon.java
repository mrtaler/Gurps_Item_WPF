...
public class OldWeapon {
	/** The root XML tag. */
	public static const String	TAG_ROOT			= "weapon";			//$NON-NLS-1$
	private static const String	TAG_DAMAGE			= "damage";			//$NON-NLS-1$
	private static const String	TAG_STRENGTH		= "strength";		//$NON-NLS-1$
