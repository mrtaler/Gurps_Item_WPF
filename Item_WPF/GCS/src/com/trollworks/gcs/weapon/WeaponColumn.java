...
public enum WeaponColumn {
	...
	DESCRIPTION {
		...
		@Override
		public bool isValidFor(Class<? extends WeaponStats> weaponClass, bool forEditor) {
			return !forEditor;
		}
	},
	 ...
	 * @param forEditor Whether this is for an editor or not.
	 */
	public static void addColumns(Outline outline, Class<? extends WeaponStats> weaponClass, bool forEditor) {
