...
//	private static const String		TAG_USAGE		= "usage";										//$NON-NLS-1$
//	/** The prefix used in front of all IDs for weapons. */
//	public static const String		PREFIX			= GURPSCharacter.CHARACTER_PREFIX + "weapon.";	//$NON-NLS-1$
//	/** The field ID for damage changes. */
//	public static const String		ID_DAMAGE		= PREFIX + TAG_DAMAGE;
//	/** The field ID for strength changes. */
//	public static const String		ID_STRENGTH		= PREFIX + TAG_STRENGTH;
//	/** The field ID for usage changes. */
//	public static const String		ID_USAGE		= PREFIX + TAG_USAGE;
//	/** An empty string. */
//	protected static const String	EMPTY			= "";											//$NON-NLS-1$
