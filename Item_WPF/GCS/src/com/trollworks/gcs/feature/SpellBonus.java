...
public class SpellBonus extends Bonus {
	/** The XML tag. */
	public static const String	TAG_ROOT				= "spell_bonus";		//$NON-NLS-1$
	/** Matches against the college name. */
	public static const String	TAG_COLLEGE_NAME		= "college_name";		//$NON-NLS-1$
	/** Matches against the power source name. */
	public static const String	TAG_POWER_SOURCE_NAME	= "power_source_name";	//$NON-NLS-1$
	/** Matches against the spell name. */
	public static const String	TAG_SPELL_NAME			= "spell_name";			//$NON-NLS-1$
	/** The XML attribute name for the "all colleges" flag. */
	public static const String	ATTRIBUTE_ALL_COLLEGES	= "all_colleges";		//$NON-NLS-1$
	private bool				mAllColleges;
	...
	public bool allColleges() {
		return mAllColleges;
	}

	/** @param all Whether the bonus applies to all colleges. */
	public void allColleges(bool all) {
		mAllColleges = all;
	}
