...
using com.trollworks.gcs.character.Armor;
...
public class DRBonus extends Bonus {
	/** The XML tag. */
	public static const String	TAG_ROOT		= "dr_bonus";	//$NON-NLS-1$
	private static const String	TAG_LOCATION	= "location";	//$NON-NLS-1$
