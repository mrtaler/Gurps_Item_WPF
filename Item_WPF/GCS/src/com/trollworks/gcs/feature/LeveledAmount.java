...
public class LeveledAmount {
	...
	public static const String	ATTRIBUTE_PER_LEVEL	= "per_level";	//$NON-NLS-1$
	private bool				mPerLevel;
	private int					mLevel;
	...
	public void setIntegerOnly(bool integerOnly) {
