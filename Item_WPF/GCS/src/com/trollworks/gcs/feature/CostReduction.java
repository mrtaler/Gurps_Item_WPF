...
public class CostReduction implements Feature {
	...
	public static const BonusAttributeType[]	TYPES			= { BonusAttributeType.ST, BonusAttributeType.DX, BonusAttributeType.IQ, BonusAttributeType.HT };
	/** The XML tag. */
	public static const String					TAG_ROOT		= "cost_reduction";																					//$NON-NLS-1$
	private static const String					TAG_ATTRIBUTE	= "attribute";																						//$NON-NLS-1$
	private static const String					TAG_PERCENTAGE	= "percentage";																						//$NON-NLS-1$
